    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Destination.this, HomeScreen.class);
        ...
        logisticsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Destination.this, TravelCommunity.class);
                startActivity(intent);
            }
        });
        ...
        diningBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Destination.this, DiningEstablishment.class);
                startActivity(intent);
            }
        });
        ...
        accommodationsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Destination.this, Accommodations.class);
                startActivity(intent);
            }
        });
